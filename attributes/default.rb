...
default['setup-vm']['rpm-dev-packages'] = %w{epel-release centos-release-scl libevent-devel make gcc-c++ curl-devel gcc openssl-devel expat-devel gettext asciidoc xmlto ncurses-devel java-1.8.0-openjdk-devel perl-ExtUtils-MakeMaker libffi-devel}
