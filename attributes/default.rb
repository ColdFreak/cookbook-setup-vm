...
default['setup-vm']['rpm-dev-packages'] = %w{libevent-devel make gcc-c++ curl-devel gcc openssl-devel expat-devel gettext asciidoc xmlto ncurses-devel java-1.8.0-openjdk-devel perl-ExtUtils-MakeMaker libffi-devel sqlite-devel bzip2-devel readline-devel}
...
default['setup-vm']['emacs']['major_version'] = "24"
default['setup-vm']['emacs']['minor_version'] = "5"
default['setup-vm']['emacs']['source_url'] = " http://ftp.jaist.ac.jp/pub/GNU/emacs/emacs-#{default['setup-vm']['emacs']['major_version']}.#{default['setup-vm']['emacs']['minor_version']}.tar.gz"
